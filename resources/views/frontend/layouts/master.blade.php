<!DOCTYPE html>
<html lang="en" ng-app="laravelCusc">
<head>
	<title>Home</title>
	<meta charset="UTF-8">
...
<body class="animsition">
	@yield('content')
	<!-- Header -->
	@include('GiaoDienNew.layouts.partials.header')

	<!-- Cart -->
	@include('GiaoDienNew.layouts.partials.cart')
	...
	<!-- Footer -->
	@include('GiaoDienNew.layouts.partials.footer')
...
<!--===============================================================================================-->
    ...
    <script>
        ...
        var app = angular.module('laravelCusc', ['ngCart'],
